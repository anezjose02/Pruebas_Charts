...
<link href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,400;0,500;1,400;1,500&family=Roboto:ital,wght@0,400;0,500;1,400;1,500&display=swap" rel="stylesheet">
...
<body class="@yield('classes_body')" @yield('body_data')>
    ...
    <script>
        $('.dropdown-toggle').click(function() {
            ...
            if( $(this).parents('.dropdown').find('.dropdown-menu').hasClass('show')){
        ...
        $('.dropdown-toggle').click(function() {
            ...
            if( $(this).parents('.dropup').find('.dropdown-menu').hasClass('show')){
